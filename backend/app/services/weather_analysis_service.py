...
def get_historical_weather_averages(daily_weather: list[WeatherDaily]) -> dict:
    ...
    averages["temperature_2m_max"] = round(mean([item.temperature_2m_max for item in daily_weather]),2)
    averages["temperature_2m_min"] = round(mean([item.temperature_2m_min for item in daily_weather]),2)
